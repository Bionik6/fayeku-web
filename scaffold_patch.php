...
function ok(string $msg): void    { global $green, $nc;  echo "{$green}[ok]{$nc}    {$msg}\n"; }
function warn(string $msg): void  { global $yellow, $nc; echo "{$yellow}[warn]{$nc}  {$msg}\n"; }
function fail(string $msg): void  { global $red, $nc;    echo "{$red}[fail]{$nc}  {$msg}\n"; exit(1); }
