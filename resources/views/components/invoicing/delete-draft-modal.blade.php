                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 sm:mt-0 sm:ml-4 sm:flex-1 text-left">
                                    <h3 class="text-base font-semibold text-slate-900">{{ __('Supprimer ce brouillon') }}</h3>
                                    ...
                                    <fieldset class="mt-4 space-y-3">
                                        <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-3 hover:border-primary/40">
                                            ...
                                            <div>
                                                <div class="text-sm font-medium text-slate-800">{{ __('Libérer le numéro') }}</div>
                                                <div class="text-xs text-slate-500">{{ __('La prochaine facture pourra utiliser ce numéro. Suppression définitive, aucune trace côté comptable.') }}</div>
                                            </div>
                                        </label>
                                        <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-3 hover:border-primary/40">
                                            ...
                                            <div>
                                                <div class="text-sm font-medium text-slate-800">{{ __('Le laisser vacant') }}</div>
                                                <div class="text-xs text-slate-500">{{ __('Numérotation avec un trou, traçable côté comptable. Le brouillon reste accessible via le filtre Archivés.') }}</div>
                                            </div>
                                        </label>
                                    </fieldset>
                                </div>
