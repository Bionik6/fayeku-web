      ...
      <form action="{{ route('marketing.accountants.join.store') }}" method="post" class="relative space-y-5 rounded-[2rem] border border-[#024D4D]/10 bg-white p-6 shadow-soft sm:p-8">
        ...
        <div class="rounded-xl border border-teal-200 bg-teal-50 p-4">
          ...
          <p class="mt-1 text-sm text-teal-700">
            ...
            <a href="{{ route('register') }}" class="font-medium underline">
        ...
        <button type="submit" class="inline-flex w-full items-center justify-center rounded-xl px-5 py-4 text-base font-semibold transition hover:brightness-110" style="background: var(--color-teal-fayeku); color: #ffffff;">
          {{ __('Soumettre') }}
        </button>
