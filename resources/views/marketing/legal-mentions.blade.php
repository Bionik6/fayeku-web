        ...
        <div class="mx-auto w-full max-w-4xl space-y-10 px-4 sm:px-6 lg:px-8">
            ...
            <div class="card p-8">
                <dl class="grid gap-6 text-base leading-7 text-slate-600 sm:grid-cols-2">
                    <div>
                        <dt class="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--color-teal-fayeku)]">Éditeur</dt>
                        <dd class="mt-2 text-ink">{{ $site['legal']['editor'] }} ({{ $site['legal']['company'] }})</dd>
                    </div>
                    <div>
                        <dt class="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--color-teal-fayeku)]">Directeur de la publication</dt>
                        <dd class="mt-2 text-ink">{{ $site['legal']['editor'] }}</dd>
                    </div>
                    <div>
                        <dt class="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--color-teal-fayeku)]">NINEA</dt>
                        <dd class="mt-2 text-ink">{{ $site['legal']['ninea'] }}</dd>
                    </div>
                    <div>
                        <dt class="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--color-teal-fayeku)]">RCCM</dt>
                        <dd class="mt-2 text-ink">{{ $site['legal']['rccm'] }}</dd>
                    </div>
                    <div class="sm:col-span-2">
                        <dt class="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--color-teal-fayeku)]">Siège social</dt>
                        <dd class="mt-2 text-ink">{{ $site['contact']['address'] }}</dd>
                    </div>
                    <div>
                        <dt class="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--color-teal-fayeku)]">Email</dt>
                        <dd class="mt-2">
                            <a href="mailto:{{ $site['contact']['email'] }}" class="text-primary hover:underline">{{ $site['contact']['email'] }}</a>
                        </dd>
                    </div>
                    <div>
                        <dt class="text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--color-teal-fayeku)]">Téléphone</dt>
                        <dd class="mt-2">
