      ...
      <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid gap-10 rounded-[2rem] border border-primary/10 bg-[#024D4D] p-8 text-white shadow-soft lg:grid-cols-[1fr_0.8fr] lg:p-12">
          <div class="space-y-5">
            ...
            <a href="/experts-comptables/" class="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-semibold text-accent">Découvrir Fayeku Compta</a>
          </div>
